    ...
    <div className="flex flex-col items-center gap-10 animate-in fade-in duration-300 w-full -mt-[30px]">
      ...
      <div className="flex flex-col md:flex-row flex-wrap justify-center items-stretch gap-6 w-full max-w-5xl mx-auto h-[60vh] min-h-[350px]">
        ...
        <div className="w-full md:w-[25%] flex flex-col gap-6">
          <Link to="/vocab" className="flex-1 rounded-[0.8rem] flex items-center justify-center transition-colors border border-white/10 hover:brightness-110 active:scale-95 transition-transform" style={{ background: themeVals.raisedGradient, boxShadow: themeVals.shadowPlateau }}>
          ...
          <Link to="/storydiary" className="flex-1 rounded-[0.8rem] flex items-center justify-center transition-colors border border-white/10 hover:brightness-110 active:scale-95 transition-transform" style={{ background: themeVals.raisedGradient, boxShadow: themeVals.shadowPlateau }}>
