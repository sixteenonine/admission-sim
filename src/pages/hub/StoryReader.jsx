...
export default function StoryReader() {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      timeoutId = setTimeout(() => {
        ...
        // บังคับโหมดแนวนอน (Desktop/Tablet Landscape) เฉพาะตอนจอเกิน 900px และกว้างกว่าสูง
        ...
        if (isLandscape) {
          ...
          // เผื่อระยะขอบ (Padding) 5% แนวนอน ป้องกันการซูมจนล้นขอบจอ
          const scaleX = (w * 0.95) / targetWidth;
          const scaleY = (h * 0.85) / targetHeight;
  ...
  return (
    <div className="w-full min-h-[100dvh] flex flex-col relative overflow-x-hidden" style={{ background: bg }}>
      ...
      {isLandscapeMode ? (
        /* 💻 Desktop & Tablet Landscape Layout (Perfectly Scaled) */
